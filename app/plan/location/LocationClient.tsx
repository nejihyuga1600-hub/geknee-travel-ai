...
// Pure-data constants live in ./globe/skins.ts — safe to edit without touching
// the 7k-line globe scene. Re-exported here so the rest of this file doesn't
// need import updates in the places it's used (Lm, monuments builder, etc).
import {
